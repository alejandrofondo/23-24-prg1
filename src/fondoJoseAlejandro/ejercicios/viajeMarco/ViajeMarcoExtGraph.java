...
public class ViajeMarcoExtGraph {
    public static void main(String[] args) {
        ...
        do {
            ...
            imprimirViaje(distanciaMarcoMadre);
    ...
    private static void imprimirViaje(double distanciaMarcoMadre) {

        distanciaMarcoMadre = distanciaMarcoMadre / 10;

        final String GRAFICO_DISTANCIA_MARCO_MADRE = ("""
            -------------------------DISTANCIA MARCO-MADRE--------------------------
            -------+-----------+---------+---------+---------+---------+-----------+
            -------| 0.........1.........2.........3.........4.........5.........6 | x10 Km
            -------| 0123456789012345678901234567890123456789012345678901234567890 |""");
        final String MARCO = ("[Marco]| º");
        final String MAMA = ("[Madre]| ");
        final String DISTANCIA_MAMA = ("@");
        final String SEPARADOR = ("-------+-----------+---------+---------+---------+---------+-----------+");

		System.out.println(GRAFICO_DISTANCIA_MARCO_MADRE);
        System.out.println(MARCO);
        System.out.print(MAMA);
        for (int i = 0; i < (int)distanciaMarcoMadre; i++) {
            System.out.print(" ");
        }
        System.out.println(DISTANCIA_MAMA);
